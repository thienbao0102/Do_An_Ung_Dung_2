...
class RatingSlider extends StatefulWidget {
  ...
  const RatingSlider({super.key, required this.question, required this.labels}); // Cập nhật constructor
          ...
          children: [
            ...
            Column(
              children: [
                    ...
                    SizedBox(
                      ...
                      child: Center(
                        child: PageView.builder(
                          ...
                          onPageChanged: (index) {
                            setState(() {
                              currentIndex = index; // Cập nhật currentIndex khi người dùng vuốt
                            });
                          },
                          itemBuilder: (context, index) {
                            return Center(
                              child: Text(
                                widget.labels[index], // Sử dụng widget.labels[index]
                                style: TextStyle(
                                  fontSize: 16,
                ...
                Row(
                  mainAxisSize: MainAxisSize.min,
                  children: List.generate(widget.labels.length, (index) { // Sử dụng widget.labels.length
                    return Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 2.0),
                      child: Container(
                        width: 30,
                        decoration: BoxDecoration(
                          color: index == currentIndex ? GlobalData().colorPrimary : Colors.grey[300],
