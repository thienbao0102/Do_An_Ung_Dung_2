...
class _CustomTableState extends State<CustomTable> {
  ...
  void initState() {
    ...
    _verticalScrollController1.addListener(() {
      if (_verticalScrollController1.position.hasPixels &&
          _verticalScrollController1.position.pixels !=
              _verticalScrollController2.position.pixels &&
                ...
                Row(
                  ...
                  children: [
                        ...
                        decoration: const InputDecoration(
                          ...
                          focusedBorder: UnderlineInputBorder(
                            borderSide: BorderSide(
                                color: Color(0xFF0062FF), width: 2.0),
                          ),
                        ...
                        onChanged: (text) {
                          setState(() {
                            ...
                            List<List<String>> searchResult =
                                search(widget.data, _controller.text);
                    ...
                    ElevatedButton(
                      ...
                      child: Text(
                          !isComparing && _showCheckboxes ? "Save" : "Compare",
                    ...
                    ElevatedButton(
                      ...
                      child: Text(
                          _showCheckboxes || isComparing ? "Cancle" : "Edit",
              ...
              child: Row(mainAxisSize: MainAxisSize.max, children: [
                ScrollbarTheme(
                  data: ScrollbarThemeData(
                    thumbColor: WidgetStateProperty.all(const Color.fromARGB(
                        118, 0, 98, 255)), // Màu của thanh cuộn
                    radius: const Radius.circular(
                        10), // Bo tròn các góc của thanh cuộn
                    thickness:
                        WidgetStateProperty.all(6), // Độ dày của thanh cuộn
                  ...
                  child: Scrollbar(
                    ...
                    child: SingleChildScrollView(
                        ...
                        controller:
                            _verticalScrollController1, // Gán ScrollController vào SingleChildScrollView
                ...
                Expanded(
                    // Sử dụng Expanded để chiếm phần không gian còn lại
                    child: ScrollbarTheme(
                        data: ScrollbarThemeData(
                          ...
                          thickness: WidgetStateProperty.all(
                              6), // Độ dày của thanh cuộn
                          minThumbLength: 50, // Độ dài tối thiểu của thanh cuộn
                        ),
                        child: Scrollbar(
                          thumbVisibility: true,
                          controller:
                              _horizontalScrollController, // Gán ScrollController vào Scrollbar
                          child: SingleChildScrollView(
                              controller:
                                  _horizontalScrollController, // Gán ScrollController vào SingleChildScrollView
                              ...
                              child: Scrollbar(
                                ...
                                child: SingleChildScrollView(
                                    ...
                                    physics: const BouncingScrollPhysics(),
                                    controller:
                                        _verticalScrollController2, // Gán ScrollController vào SingleChildScrollView
                                    child: Column(
                                      children: [
                                        Table(
                                          columnWidths: {
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        onTap: () {
          ...
          setState(() {
            if (_sortButtonDegrees[buttonId] == 0 ||
                _sortButtonDegrees[buttonId] == null) {
        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
            ...
            border: Border(
              right: BorderSide(
                  color: Color.fromARGB(255, 235, 234, 234), width: 1),
            ),
          ),
        ...
        child: (text == "Pass" || text == "Fail")
            ? Container(
                ...
                decoration: BoxDecoration(
                  border: Border.all(
                    color: text == "Pass"
                        ? const Color.fromARGB(255, 108, 160, 120)
                        : const Color.fromARGB(255, 197, 161,
                            161), // Nếu là "Pass" thì màu xanh, ngược lại màu đỏ
                    width: 1,
                  ),
                  borderRadius: BorderRadius.circular(10),
                  color: text == "Pass"
                      ? const Color.fromARGB(255, 210, 255, 217)
                      : const Color.fromARGB(255, 253, 224, 228),
                ), // Nếu là "Pass" thì màu xanh, ngược lại màu đỏ),
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    fontSize: 14,
                    color: text == "Pass"
                        ? const Color.fromARGB(255, 3, 176, 43)
                        : const Color.fromARGB(255, 201, 97, 97),
                  ),
                  textAlign: TextAlign.center,
                ),
              )
            : (text == "yes" || text == "no")
                ? text == "yes"
                    ? SvgPicture.asset(
                        "assets/Check.svg", // Hiển thị icon check khi text là "yes"
                        width: 20,
                        height: 20,
                      )
                    : SvgPicture.asset(
                        "assets/X.svg", // Hiển thị icon "X" khi text là "no"
                        width: 20,
                        height: 20,
                      )
                : Text(
  ...
  TableRow _buildRow(
    ...
    return TableRow(
      decoration: BoxDecoration(
        color: numOfRow % 2 == 0
            ? Colors.white
            : Colors.lightBlue.shade50, // Dòng lẻ trắng, dòng chẵn xanh nhạt
      ),
      children: [
        // _buildCell(no),
        // _buildCell(name),
        ...
        children: [
          MouseRegion(
            ...
            child: GestureDetector(
              onTap: () {
                setState(() {
                  checkboxes[rowId] = !(checkboxes[rowId] ??
                      false); // Đảo ngược trạng thái của dòng
              ...
              child: Container(
                ...
                child: _buildCheckBox(
                    checkboxes[rowId] ?? false), // Lấy trạng thái từ Map
              ),
            ),
          ),
          _buildCell(no),
  ...
  SvgPicture _buildCheckBox(bool isChecked) {
    if (isChecked) {
      return SvgPicture.asset(
        'assets/check-box-icon-checked.svg',
        width: 14,
        height: 14,
      );
    } else {
      return SvgPicture.asset(
        'assets/check-box-icon-unchecked.svg',
        width: 14,
        height: 14,
      );
    }
  ...
  Widget _buildSortButton(int rotationDegree) {
    return AnimatedRotation(
        turns: rotationDegree == -1
            ? 0 / 360
            : rotationDegree /
                360, // Góc xoay từ 0 đến 1 (0 = 0 độ, 1 = 360 độ); -1 is unactive
        duration: const Duration(milliseconds: 0), // Thời gian chuyển động
        child: rotationDegree == -1
            ? SvgPicture.asset(
                'assets/sort-icon-unactive.svg',
                width: 24,
                height: 24,
              )
            : SvgPicture.asset(
  ...
  List<List<String>> sortData(
      List<List<String>> data, int buttonId, bool ascending) {
    List<List<String>> sortedData = data;
    switch (buttonId) {
      case 1:
        sortedData.sort(
            (a, b) => ascending ? a[0].compareTo(b[0]) : b[0].compareTo(a[0]));
        break;
      case 2:
        sortedData.sort(
      ...
      case 3:
        sortedData.sort(
            (a, b) => ascending ? a[2].compareTo(b[2]) : b[2].compareTo(a[2]));
        break;
      case 4:
        sortedData.sort(
            (a, b) => ascending ? a[3].compareTo(b[3]) : b[3].compareTo(a[3]));
        break;
      case 5:
        sortedData.sort(
            (a, b) => ascending ? a[4].compareTo(b[4]) : b[4].compareTo(a[4]));
        break;
      case 6:
        sortedData.sort(
            (a, b) => ascending ? a[5].compareTo(b[5]) : b[5].compareTo(a[5]));
        break;
      case 7:
        sortedData.sort(
            (a, b) => ascending ? a[6].compareTo(b[6]) : b[6].compareTo(a[6]));
        break;
      case 8:
        sortedData.sort(
            (a, b) => ascending ? a[7].compareTo(b[7]) : b[7].compareTo(a[7]));
        break;
      case 9:
        sortedData.sort(
            (a, b) => ascending ? a[8].compareTo(b[8]) : b[8].compareTo(a[8]));
        break;
      case 10:
        sortedData.sort(
            (a, b) => ascending ? a[9].compareTo(b[9]) : b[9].compareTo(a[9]));
        break;
      case 11:
        sortedData.sort((a, b) =>
            ascending ? a[10].compareTo(b[10]) : b[10].compareTo(a[10]));
        break;
      case 12:
        sortedData.sort((a, b) =>
            ascending ? a[11].compareTo(b[11]) : b[11].compareTo(a[11]));
        break;
      case 13:
        sortedData.sort((a, b) =>
            ascending ? a[12].compareTo(b[12]) : b[12].compareTo(a[12]));
        break;
      case 14:
        sortedData.sort((a, b) =>
            ascending ? a[13].compareTo(b[13]) : b[13].compareTo(a[13]));
        break;
      case 15:
        sortedData.sort((a, b) =>
            ascending ? a[14].compareTo(b[14]) : b[14].compareTo(a[14]));
        break;
      case 16:
        sortedData.sort((a, b) =>
            ascending ? a[15].compareTo(b[15]) : b[15].compareTo(a[15]));
        break;
      case 17:
        sortedData.sort((a, b) =>
            ascending ? a[16].compareTo(b[16]) : b[16].compareTo(a[16]));
        break;
      case 18:
        sortedData.sort((a, b) =>
            ascending ? a[17].compareTo(b[17]) : b[17].compareTo(a[17]));
        break;
      case 19:
        sortedData.sort((a, b) =>
            ascending ? a[18].compareTo(b[18]) : b[18].compareTo(a[18]));
        break;
      case 20:
        sortedData.sort((a, b) =>
            ascending ? a[19].compareTo(b[19]) : b[19].compareTo(a[19]));
        break;
      case 21:
        sortedData.sort((a, b) =>
            ascending ? a[20].compareTo(b[20]) : b[20].compareTo(a[20]));
        break;
      case 22:
        sortedData.sort((a, b) =>
            ascending ? a[21].compareTo(b[21]) : b[21].compareTo(a[21]));
        break;
      case 23:
        sortedData.sort((a, b) =>
            ascending ? a[22].compareTo(b[22]) : b[22].compareTo(a[22]));
        break;
      case 24:
        sortedData.sort((a, b) =>
            ascending ? a[23].compareTo(b[23]) : b[23].compareTo(a[23]));
        break;
      case 25:
        sortedData.sort((a, b) =>
            ascending ? a[24].compareTo(b[24]) : b[24].compareTo(a[24]));
        break;
      case 26:
        sortedData.sort((a, b) =>
            ascending ? a[25].compareTo(b[25]) : b[25].compareTo(a[25]));
        break;
      case 27:
        sortedData.sort((a, b) =>
            ascending ? a[26].compareTo(b[26]) : b[26].compareTo(a[26]));
        break;
      case 28:
        sortedData.sort((a, b) =>
            ascending ? a[27].compareTo(b[27]) : b[27].compareTo(a[27]));
        break;
      case 29:
        sortedData.sort((a, b) =>
            ascending ? a[28].compareTo(b[28]) : b[28].compareTo(a[28]));
        break;
      case 30:
        sortedData.sort((a, b) =>
            ascending ? a[29].compareTo(b[29]) : b[29].compareTo(a[29]));
        break;
      case 31:
        sortedData.sort((a, b) =>
            ascending ? a[30].compareTo(b[30]) : b[30].compareTo(a[30]));
        break;
      case 32:
        sortedData.sort((a, b) =>
            ascending ? a[31].compareTo(b[31]) : b[31].compareTo(a[31]));
        break;
      case 33:
        sortedData.sort((a, b) =>
            ascending ? a[32].compareTo(b[32]) : b[32].compareTo(a[32]));
        break;
      case 34:
        sortedData.sort((a, b) =>
            ascending ? a[33].compareTo(b[33]) : b[33].compareTo(a[33]));
        break;
      case 35:
        sortedData.sort((a, b) =>
            ascending ? a[34].compareTo(b[34]) : b[34].compareTo(a[34]));
        break;
      default:
  ...
  List<List<String>> compareRowSelected(
      List<int> rowIdSelected, List<List<String>> data) {
    List<List<String>> result = [];
    result =
        data.where((row) => rowIdSelected.contains(int.parse(row[0]))).toList();
    return result;
  }
}
